...
Now that you have everything configured to your server, use the **\`help\`** command to read more about what I can do.`;

    guild.owner.user.send(guildOwnerWelcome).catch(console.error);

    const guildWelcome = `*Vrrrrrvd tkk tkkdtk*
Hello! I am ${client.user.username}! I have a lot of commands you can use (or not use). Type \`${settings.prefix}help\` for more.`;
